...
// RC VacuousTrx::update_record(Table *table, Record &record, std::vector<Value*> &values, std::vector<FieldMeta*> &fields) { return table->update_record(record, values, fields); }
